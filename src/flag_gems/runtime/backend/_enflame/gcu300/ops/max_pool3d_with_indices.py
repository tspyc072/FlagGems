...
def max_pool3d_with_indices(
    ...
    """
    logger.debug("GEMS_ENFLAME MAX_POOL3D_WITH_INDICES")
    ...
    indices_i32 = torch.empty(
        (in_n, in_c, out_d, out_h, out_w), device=input.device, dtype=torch.int32
    )
...
def max_pool3d_backward(
    ...
    logger.debug("GEMS_ENFLAME MAX_POOL3D BACKWARD")
